define([
        ...
        "dojo/text!./templates/TagsEditor.html"
],
    function (
        dojo,
        array,
        ...
        return declare("amaze/editors/TagsSelection", [_Container, _LayoutWidget, _TemplatedMixin, _WidgetsInTemplateMixin, _CssStateMixin, _ValueRequiredMixin, _ContextMixin], {
            ...
            postCreate: function () {
                ...
                if (!this.store) {
                    ...
                    this.store = this.store || registry.get("tagsstore");
                }
            ...
            _contextChanged: function (newContext) {
                if (newContext) {
                    ...
                    this.contentLink = this.context.id;
                }
            },
